                        ...
                        <h5>Add Author</h5>
                            <form action="{{ route('author.store') }}" method="POST" role="form" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="email" class="form-control form-control-line" name="email" value=""  id="example-email">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="role" value="" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-6">Facebook</label>
                                    <div class="col-md-6">
                                        <input type="text" name="facebook" value="" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-6">Twitter</label>
                                    <div class="col-md-6">
                                        <input type="text" name="twitter" value="" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-6">Instragram</label>
                                    <div class="col-md-6">
                                        <input type="text" name="instragram" value="" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-6">Linkedin</label>
                                    <div class="col-md-6">
                                        <input type="text" name="linkedin" value="" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-6">
