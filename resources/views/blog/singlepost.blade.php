        ...
        <div class="row">
          <div class="col-md-9" data-aos="fade-up">
            ...
            <div class="single-post">
              ...
              <div class="post-meta pt-3"><span class="date">{{$post->user->name}}</span> <span class="mx-1"> | </span> <span>{{$post->created_at->format('M d Y')}}</span> <span class="mx-1"> | </span> <span class="date">{{$post->category->name}}</span></div>
