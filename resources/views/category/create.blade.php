    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <a href="{{ url('category/index') }}" class="btn waves-effect waves-light btn btn-info pull-right hidden-sm-down"> Back</a>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('category.store') }}" method="POST" role="form">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button class="btn btn-success">Upload Category</button>
                                </div>
                            </div>
                        </form>
                    </div>
