    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <a href="{{ route('category.index') }}" class="btn waves-effect waves-light btn btn-info pull-right hidden-sm-down"> Back</a>
            </div>
        </div>
        <!-- ============================================================== -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <h5>Edit Category</h5>
                        <form action="{{ route('category.update') }}" method="POST" role="form">
                                @csrf
