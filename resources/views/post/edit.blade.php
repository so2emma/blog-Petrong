                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('post.update') }}" method="POST" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="title" value="{{ $post->title }}" class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-6">Sub Title</label>
                                <div class="col-md-6">
                                    <input type="text" name="subtitle" value="{{ $post->subtitle }}" class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-6">Content</label>
                                <div class="col-md-6">
                                    <textarea rows="5" name="content" class="form-control form-control-line"> {{ $post->content }} </textarea>
                                </div>
                            </div>
                            <div class="form-group">
